...
28. [⚪] - When i click on any of the cards in the visualization UI, I would like to open a modal popup showing the all of the specific OSC commands being send and their values in real time, so it's easy for me to program the OSC reciever.
