...
38. [⚪] - Documentation review: audit README.md, help page, and CLAUDE.md to ensure the OSC interface documentation is up to date with all recent additions (input conditioning, scene change, energy direction, vocal likelihood). Update output reference tables, feature descriptions, and architecture notes.
